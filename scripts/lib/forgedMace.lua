...
forgedWeapon.makeWeapon = function()
    ...
    desc = function(self, item)
        ...
        return {
            ...
            imageFile = "items/forgedMace.png",
            equipable = "weapon"
        }
	...
	damageRoll = function(self,item,user)
      ...
      minDmg = math.min((self.data.minDmg +self.data.tier*item:level())*1.2,maxDmg)
    ...
    accuracyFactor = function(self,item,user)
      str = math.max(self.data.str-2*item:level(),1)
      return self.data.accuracy + RPG.itemStrBonus(str)-0.1
    end,
   
    
    attackDelayFactor = function(self,item,user)
      str = math.max(self.data.str-2*item:level(),1)
      return math.max(self.data.delay - RPG.itemStrBonus(str)+0.1,0.25)
    end,
