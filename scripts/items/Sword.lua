...
return item.init{
    ...
    info = function(self,item)
      ...
      str = stra-item:level()
      local info = "Отблеск острого, как бритва, клинка внушает уверенность. \n\nМеч - оружие ближнего боя "..tier.." порядка. Средний урон составляет "..math.ceil((maxDmg+minDmg+tier*item:level()*2)/2).." единиц за удар и, как правило, требует "..stra.." очков силы.\n\n"..self.data.sInfo
