...
return item.init{
    ...
    info = function(self,item)
      ...
      local info = RPD.textById("Longsword_Info").."\n\n"..RPD.textById("Longsword_Name")..RPD.textById("WeaponInfo0")..tier..RPD.textById("WeaponInfo1")..math.ceil((maxDmg+minDmg+tier*item:level()*2)/2)..RPD.textById("WeaponInfo2")..str..RPD.textById("WeaponInfo3")..RPD.textById("").."\n\n"..self.data.sInfo
