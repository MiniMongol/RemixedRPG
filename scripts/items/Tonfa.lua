...
return item.init{
    ...
    info = function(self,item)
      ...
      str = stra-item:level()
      local info = RPD.textById("Tonfa_Info").."\n\n"..RPD.textById("Tonfa_Name")..RPD.textById("WeaponInfo0")..tier..RPD.textById("WeaponInfo1")..math.ceil((maxDmg+minDmg+tier*item:level()*2)/2)..RPD.textById("WeaponInfo2")..stra..RPD.textById("WeaponInfo3")..RPD.textById("WeaponCounter").."\n"..self.data.sInfo
