...
return item.init{
    desc  = function (self, item)
      ...
      stats = a[2]
        ...
        return {
            ...
            name          = RPD.textById("RatArmor_Name")..": "..tostring(math.max(stra-2*item:level(),1)),
    ...
    info = function(self,item)
      ...
      local info = RPD.textById("RatArmor_Info").."\n\n"..RPD.textById("RatArmor_Name")..RPD.textById("ArmorInfo0")..tier..RPD.textById("ArmorInfo1")..tier*2+item:level()*tier..RPD.textById("ArmorInfo2")..str..RPD.textById("ArmorInfo3").."\n\n"..self.data.sInfo
