...
return item.init{
    ...
    info = function(self,item)
      ...
      local info = RPD.textById("PlateArmor_Desc").."\n\n"..RPD.textById("PlateArmor_Name")..RPD.textById("ArmorInfo0")..tier..RPD.textById("ArmorInfo1")..tier*2+item:level()*tier..RPD.textById("ArmorInfo2")..str..RPD.textById("ArmorInfo3").."\n\n"..self.data.sInfo
