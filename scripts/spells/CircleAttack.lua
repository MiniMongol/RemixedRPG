     ...
     for i = x-1,x+1 do
      for j = y-1,y+1 do
       ...
       if enemy and enemy ~= RPD.Dungeon.hero then
        RPG.damage(enemy,(math.ceil(RPG.physStr()*0.1 + RPG.AllFast()*0.25) + weaponA:damageRoll(hero) + weaponB:damageRoll(hero)*0.65 + 2*lvl)-enemy:dr(), type,elmnt)
