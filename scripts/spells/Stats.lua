...
if RPG.class == "Mage" then
 if index == 0 then
   sMas = {"Stats","MagicBolt","ShadowClone","Chop","Fireball","EarthHeal","Lightning"}
   Que.pushMas(sList,sMas)
   RPG.subclass = "BattleMage"
 end
 if index == 1 then
   sMas= {"Stats","MagicBolt","ShadowClone","Chop","BloodSpikes", "ThornsOfAgony","PandemicLance"}
   Que.pushMas(sList,sMas)
   RPG.subclass = "Demonologist"
 end
 if index == 2 then
   sMas = {"Stats","MagicBolt","ShadowClone","Chop","SummonBoneGolem","RageSouls","BoneArmor"}
    Que.pushMas(sList,sMas)
 ...
 if index == 1 then
  ...
  if index1-1 == 4 then
    if RPG.sPoints ~= 0 then
      ...
      RPG.magDef = RPG.magDef +1
      if RPG.wisdom %3 == 0 and RPG.subclass == "Paladin" or RPG.subclass == "Enchater" then
        RPG.magDef = RPG.magDef +1
      end
...
return spell.init{
    ...
    local sMas = {"Stats","MagicBolt","ShadowClone","Chop"}
     Que.pushMas(sList,sMas) 
