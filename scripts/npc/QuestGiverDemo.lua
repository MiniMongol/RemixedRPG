...
П-привет, твоя помочь мне может? Огромный тебе спасибо~. Я недавно сюда приехать, но моя деньга не принимать. Я могу  мне здешний трав нужна, принесёшь?"
...
return mob.init({
    interact = function(self, chr)
        ...
        if ratsKilled < 5 then
            ...
            RPD.Dungeon.level:drop(RPD.ItemFactory:itemByName("ModRatArmor"),chr:getPos())
